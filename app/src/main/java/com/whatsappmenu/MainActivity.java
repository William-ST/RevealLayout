...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton btnDocument = new ImageButton(this);//(ImageButton) findViewById(R.id.menu_attachment_document);
        ImageButton btnCamera = new ImageButton(this);//(ImageButton) findViewById(R.id.menu_attachment_camera);
        ImageButton btnGallery = new ImageButton(this);//(ImageButton) findViewById(R.id.menu_attachment_gallery);
        ImageButton btnAudio = new ImageButton(this);//(ImageButton) findViewById(R.id.menu_attachment_audio);
        ImageButton btnLocation = new ImageButton(this);//(ImageButton) findViewById(R.id.menu_attachment_location);
        ImageButton btnContact = new ImageButton(this);//(ImageButton) findViewById(R.id.menu_attachment_contact);
